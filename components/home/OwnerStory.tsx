...
export function OwnerStory() {
  return (
    <section
      ...
      className="section-warm texture-linen relative overflow-hidden bg-[#EDE1D2] pb-4 pt-7 lg:pb-[40px] lg:pt-[18px]"
    >
        ...
        <div className="grid items-center gap-6 border-t border-[#D9C8B5] pt-7 lg:grid-cols-[0.85fr_1.15fr] lg:gap-12 lg:pt-7">
          <div className="relative mx-auto aspect-[4/5] w-full max-w-[230px] overflow-hidden border border-[#C6A36A]/35 bg-[#F7F1E8] shadow-[0_18px_48px_rgba(42,23,18,0.08)] lg:max-w-[360px] lg:shadow-[0_24px_70px_rgba(42,23,18,0.10)]">
            <Image
              ...
              className="scale-[1.12] object-cover object-[center_58%]"
            />
            <div className="absolute inset-x-4 bottom-4 top-7 border border-[#F7F1E8]/55" aria-hidden />
          ...
          <div className="mx-auto w-full max-w-[700px] text-center lg:text-left">
            ...
            <h2 className="font-serif text-[2.2rem] leading-none text-virtuosa-deep-brown lg:text-[2.8rem] lg:leading-[1.05]">
              Elaine Soares
            </h2>
            ...
            <div className="mt-5 hidden space-y-3 font-sans text-[0.9rem] leading-[1.62] text-virtuosa-light-brown lg:block">
              <p>
              ...
              <p className="pt-1 font-serif text-[1.1rem] leading-relaxed text-virtuosa-deep-brown">
