      ...
      <div className="container-virtuosa relative">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[44%_56%] lg:gap-16">
          ...
          <div className="relative flex flex-col items-start lg:pl-4">
            ...
            <p className="mb-4 inline-flex items-center gap-2 font-sans text-[10px] font-bold uppercase tracking-[0.18em] text-virtuosa-antique-gold">
              <span className="flex h-7 w-7 items-center justify-center rounded-full border border-virtuosa-antique-gold/45 text-[15px]" aria-hidden>
                ↓
              </span>
